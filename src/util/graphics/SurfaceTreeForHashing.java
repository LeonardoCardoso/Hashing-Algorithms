...
public class SurfaceTreeForHashing extends JPanel {
    ...
    public static final int DIMENSION_TOP = 66, DIMENSION_LEFT = 70, DIMENSION_WIDTH = 100, DIMENSION_HEIGHT = 60;
    ...
    public SurfaceTreeForHashing(String title, AVLNode[] nodes, Double loadFactor, Double balacingFactor) {
        setDimensions();
        this.title = title;
        this.nodes = nodes;
    ...
    private void buildData() {
        ...
        for (int i = 0; i < nodes.length; i++) {
            ...
            if (node != null && node.getAVLTree() != null) {
                ...
                printAll(tree.top(), null, null, i);
            } else {
                printAll(null, null, null, i);
            }
        }
    }
